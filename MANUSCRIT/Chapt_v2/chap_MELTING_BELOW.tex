...
While the melting continue to expand to the right side of the domain, a natural convection flow emerges from the top of the cavity (see Fig. (\ref{fig:melt-field}b)). 
...
Since $\Pr \gg 1$, the scaling presented in eq. (\ref{eq-scale-nbd-high-Pr}) allows to evaluate the thermal boundary layer in this region as:
...
\begin{figure}
	\begin{center}
		\includegraphics[width=\textwidth]{\figpath/Fig_cap_melting/fig06}		
	\end{center}
...
\begin{figure}
	...
	\end{center}
	\caption{Complete melting of the PCM.} \label{fig:melt-comp-Ra}
\end{figure}
