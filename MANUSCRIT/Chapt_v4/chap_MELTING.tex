...
This approach has physical a significance and is more robust when higher Rayleigh number simulations are performed.
...
We also assess on the effect of tubes arrangements with a fixed number of obstacle. 
...
In this chapter, we demonstrated the capability our numerical method to produce highly accurate solutions of difficult multiphysics problems on several geometrical configurations.
...
Comparison with existing benchmarks showed for each case a very good agreement.
