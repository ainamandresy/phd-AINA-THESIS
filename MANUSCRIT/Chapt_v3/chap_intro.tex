...
With regard to theoretical works, \cite{vasil2011dynamic,favier2019rayleigh} have studied the hydrodynamic instabilities at the onset of convection and compared their observation with the classical Rayleigh-Bénard instability mechanism \citep{chandrasekhar2013hydrodynamic}.
...
A high accuracy numerical model using a Newton method with an adaptive finite element is used to simulate phase-change problems with natural convection.
...
\noindent A third objective is to provide a thorough analysis of both melting and solidification process using the developed tools.
...
Then numerical results for the melting from below is then presented.
For  both cases, we provide comprehensive description of the melting process through a scale analysis for better understanding of the heat transfer mechanism.
