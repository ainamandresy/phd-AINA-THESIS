...
%\sectionmark{head version}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\def\titcourt{Numerical simulation of natural convection flow in 2D configurations}
\def\titlong{Numerical simulation of natural convection flow in 2D configurations}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Internal convection flow is a relevant case to validate rigorously the Navier-Stokes-Boussinesq solver since the publications related to the subject is very abundant in the literature.
...
Linear and non-linear expressions of the buoyancy force $f_B(T)$ in the Boussinesq approximation (Eq. \ref{eq-energie-enth-model}) are investigated, by simulating the natural convection of air and the natural convection of water.
...
Two cases are carried out: {\textit i)} a differentially heated square cavity and {\textit ii)} a differentially heated cavity with inner heated obstacle.
