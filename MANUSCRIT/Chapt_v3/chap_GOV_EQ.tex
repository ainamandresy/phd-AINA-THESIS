...
We consider a solid-liquid system placed in a domain $\Omega$ of characteristic length $L_{ref}$. 
...
The solid-liquid interface is identified through the isoline $T=T_f$, and the Gibbs-Thomson effect due to the surface energy of the solid-liquid interface which is assumed to be negligible.% in our simulations.
