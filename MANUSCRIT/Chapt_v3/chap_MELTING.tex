...
A first possibility is setting a very thin fluid layer of thickness $\delta x = 0.01$ with isothermal temperature in the vicinity of the hot wall (see \cite{dan-2014-JCP,Belhamadia2004_S}.
...
%For all cases, at $t=0$ the PCM is fully solid at temperature under the temperature of fusion $\theta_h$.
