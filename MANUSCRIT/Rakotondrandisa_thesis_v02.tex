...
\newcommand*\chaptpath{\dsk/Chapt_v2}
\newcommand*\incpath{.}
%========================================================================
...
\title[frenchb]{Simulation numérique des matériaux à changement de phases.}
%Titles for other languages
\title[english]{Numerical simulation of phase-change materials.}

%Keywords for main language (french)
\keywords[frenchb]{Convection naturelle, méthodes d'ordre élevé, différences finies, éléments finis, méthode de frontières immergées, étude numérique.}
